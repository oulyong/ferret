...
void record_listening_port(struct Ferret *ferret, unsigned hops, unsigned ipver, unsigned ip, const unsigned char *ipv6, unsigned transport, unsigned port, const char *proto, const char *banner, unsigned banner_length);
